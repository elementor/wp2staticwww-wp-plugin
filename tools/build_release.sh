...
######################################
##
## Build WP2Static WWW Custom Plugin
##
...
rm -Rf "$TMP_DIR/wp2staticwww-wp-plugin"
mkdir "$TMP_DIR/wp2staticwww-wp-plugin"
...
cp -r "$EXEC_DIR"/*.php "$TMP_DIR"/wp2staticwww-wp-plugin/
...
zip --quiet -r -9 "./$1.zip" ./wp2staticwww-wp-plugin
